...
switch ($_GET['op']) {
    case 'añadir':
        ...
        $sexoregistromantenimiento = $_POST['select_sexoañadir'];
        ...
        if ($sexoregistromantenimiento == 1) {
            $tiposexoañadir = "M";
        } elseif ($sexoregistromantenimiento == 2) {
            $tiposexoañadir = "F";
        } else {
            $tiposexoañadir = "NF";
        }
    ...
    case 'editar':
        $sexoregistromantenimientoeditar = $_POST['select_sexoeditar'];
        ...
        if ($sexoregistromantenimientoeditar == 1) {
            $tiposexoeditar = "M";
        } elseif ($sexoregistromantenimientoeditar == 2) {
            $tiposexoeditar = "F";
        } else {
            $tiposexoeditar = "NF";
        }

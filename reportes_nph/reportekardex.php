...
if ($filtrokardex!="") {
 ...
 where id_kardex like '$coincidenciakardex' 
 or Producto like '$coincidenciakardex' 
 or Cantidad_Producto like '$coincidenciakardex' 
 or Empleado like '$coincidenciakardex' 
 or Fecha_Hora like '$coincidenciakardex' 
 or Tipo_Movimiento like '$coincidenciakardex'" ;
...
while ($data = $resultado->fetch_assoc()) {
	...
	$pdf->setX(15);
	$pdf->Row(array($i + 1, utf8_decode($data['id_kardex']), utf8_decode($data['Producto']), utf8_decode($data['Cantidad_Producto']), utf8_decode($data['Empleado']), utf8_decode($data['Fecha_Hora']), utf8_decode($data['Tipo_Movimiento'])), 25); //EL 28 ES EL MARGEN QUE TIENE DE DERECHA
	$i = $i + 1;
}

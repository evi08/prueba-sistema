...
class PDF extends FPDF
{
	function Header()
	{
		...
		$this->SetY(30);
		$this->SetX(100);
		$this->Cell(10, 10, utf8_decode('           REPORTE DE DETALLES DE COMPRAS '));
		$this->SetX(5);
		$this->Ln(11);
		...
		$this->Cell(40, 12, utf8_decode("Compras"), 1, 0, 'C', 1);
		$this->Cell(70, 12, utf8_decode("Producto"), 1, 0, 'C', 1);
		$this->Cell(60, 12, utf8_decode("Cantidad"), 1, 0, 'C', 1);
		$this->Cell(60, 12, utf8_decode("Precio"), 1, 1, 'C', 1);//salto de linea
		//El ancho de las celdas
		$this->SetWidths(array(20, 40, 40, 70,60, 60)); //???
	}
...
if ($filtrodetallec!="") {
	$coincidenciadetallec = "%".$filtrodetallec."%";
 ...
 ( d.id_detalle_compra like '$coincidenciadetallec' 
 or d.id_compra like '$coincidenciadetallec' 
 or p.nombre_producto like '$coincidenciadetallec'
 or d.cantidad like '$coincidenciadetallec'
 or d.precio_compra  like '$coincidenciadetallec')" ;
...
while ($data = $resultado->fetch_assoc()) {
	...
	$pdf->setX(15);
	$pdf->Row(array($i + 1, utf8_decode($data['id_detalle_compra']), utf8_decode($data['id_compra']), utf8_decode($data['nombre_producto']),utf8_decode($data['cantidad']),utf8_decode($data['precio_compra'])), 25); //EL 28 ES EL MARGEN QUE TIENE DE DERECHA
	$i = $i + 1;
}

// cell(ancho, largo, contenido,borde?, salto de linea?)

$pdf->Output('I', 'Reportedetallecompras.pdf');

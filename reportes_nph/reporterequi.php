...
class PDF extends FPDF
{
	function Header()
	{
		...
		$this->Cell(40, 12, utf8_decode("Estado Solicitud"), 1, 1, 'C', 1);//salto de linea

		//El ancho de las celdas
		$this->SetWidths(array(15, 25, 35, 60, 40, 40, 35, 40)); //???
	}
...
if ($filtrorequi != "") {
	...
	or d.nombre_departamento like '$coincidenciarequi'
	or concat(em.primer_nombre,\" \",em.segundo_nombre,\" \",em.primer_apellido,\" \",em.segundo_apellido) like '$coincidenciarequi'
